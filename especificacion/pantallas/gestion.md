...
- El detalle de asociado es el centro operativo: muestra datos, deuda, cuotas del año y pagos recientes. Su encabezado ofrece únicamente `Cobrar` y `Editar asociado`, según permisos, y una navegación secundaria vuelve a la consulta conservando sus filtros.
...
- La vista histórica de cuotas, la auditoría filtrada y la creación individual de usuario conservan temporalmente sus rutas y permisos, pero no tienen acceso desde el detalle mientras se diseñan sus recorridos definitivos.
- Cursos.
- Períodos de cuota.
- Generar cuotas.
