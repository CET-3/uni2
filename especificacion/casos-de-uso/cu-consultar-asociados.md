...
3.  Opcionalmente acota por estado, tipo, curso actual, clasificación de
    adherente, con o sin usuario y con o sin deuda.
...
**Filtros útiles:** estado, tipo, curso actual, clasificación de adherente,
presencia de usuario y presencia de deuda.

**Modelos afectados:** Asociado, Curso, ClasificacionAdherente, Cuota.
