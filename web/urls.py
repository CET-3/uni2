...
urlpatterns = [
    ...
    path("productos-servicios/<int:pk>/<slug:slug>/", ProductoServicioDetalleView.as_view(), name="producto_servicio_detalle_seo"),
    ...
    path("comercios/<int:pk>/<slug:slug>/", ComercioDetalleView.as_view(), name="comercio_detalle_seo"),
    path("comercios/<int:pk>/", ComercioDetalleView.as_view(), name="comercio_detalle"),
    path("servicios/<int:pk>/<slug:slug>/", CategoriaProductoServicioDetalleView.as_view(), name="categoria_detalle_seo"),
    path("servicios/<int:pk>/", CategoriaProductoServicioDetalleView.as_view(), name="categoria_detalle"),
    path("actividades-comerciales/<int:pk>/<slug:slug>/", ActividadComercialDetalleView.as_view(), name="actividad_comercial_detalle_seo"),
